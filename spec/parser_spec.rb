...
#     before(:each) do
#       @listener = mock :listener, :empty_line => ''
#     end
#     
...
#   end
#   
#   describe "parsing permissions" do
#     before(:each) do
#       @listener = mock :listener, :empty_line => ''
#     end
#         
#     # it "should notify the listerner when parsing a permssion with no permissision" do
#     #      @listener.should_receive(:permission).with('', '@evil-decepticons')
#     #      parser = SvnAuthFile::Parser.new file_examples[:permission_with_no_permission], @listener
#     #      parser.parse
#     #    end
#   end
# end